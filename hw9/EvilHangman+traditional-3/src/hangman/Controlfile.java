...
import java.util.Scanner;
  ...
  */
	...
	/**
	 * get the legal word list from file
	 * @param file the file
	 * @return the arraylist
	 * @throws FileNotFoundException the file
	 */
	public ArrayList<String>  GetLegalWordArraylist(File file) throws IOException {
		
		ArrayList<String> legalWord= new ArrayList<String>();
		BufferedReader br= new BufferedReader (new FileReader(file));
		String line=null;
		while((line=br.readLine())!=null) {
			if(this.IfTheWordIsLegal(line)==true) {
				legalWord.add(line);
			}
		}
		return legalWord;	
