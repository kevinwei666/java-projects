...
class playcontrollerTest {
	 ...
	 * the string arrays
	 */
	//the string array used in the program
	String []a= {"q","_"};
	String []b= {"w","u","h"};
	String []c= {"_","_"};
	...
	/**
	 * test the generateKeyValue method
	 */
	@Test
	void generateKeyValuetest() {
		//set different conditions
		letter="a";
		word="abc";
		assertEquals("_//",playcontroller.generateKeyValue(letter,word));
		letter="n";
		word="abc";
		assertEquals("///",playcontroller.generateKeyValue(letter,word));
		letter="c";
		word="abc";
		assertEquals("//_",playcontroller.generateKeyValue(letter,word));
	}
